...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:StructureDefinition/f:differential/f:element">
      ...
      <sch:assert test="count(f:mustHaveValue) &lt;= 1">mustHaveValue: maximum cardinality of 'mustHaveValue' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:StructureDefinition/f:differential/f:element/f:constraint">
      ...
      <sch:assert test="count(f:suppress) &lt;= 1">suppress: maximum cardinality of 'suppress' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:StructureDefinition/f:differential/f:element/f:binding/f:additional</sch:title>
    <sch:rule context="f:StructureDefinition/f:differential/f:element/f:binding/f:additional">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      ...
      <sch:assert test="count(f:valueSet) &gt;= 1">valueSet: minimum cardinality of 'valueSet' is 1</sch:assert>
      <sch:assert test="count(f:valueSet) &lt;= 1">valueSet: maximum cardinality of 'valueSet' is 1</sch:assert>
      <sch:assert test="count(f:documentation) &lt;= 1">documentation: maximum cardinality of 'documentation' is 1</sch:assert>
      <sch:assert test="count(f:shortDoco) &lt;= 1">shortDoco: maximum cardinality of 'shortDoco' is 1</sch:assert>
      <sch:assert test="count(f:any) &lt;= 1">any: maximum cardinality of 'any' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
